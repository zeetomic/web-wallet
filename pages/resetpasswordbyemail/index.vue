...
import { validateResetByEmail } from '~/utils/Mixin/validateForgetPassword.js';

export default {
  layout: 'login_register',
  mixins: [message, validateResetByEmail],
  data() {
    return {
      temp_code: '',
      email: '',
  ...
  methods: {
    handleSubmit() {
      ...
      {
        this.loading = true;
        this.$store.dispatch('users/handleResetPasswordByEmail', {
